...
function AssignRoles() {
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li onClick={redirect_to_home}><a class="nav-link scrollto active" href="#h">Supply Chain</a></li>
  ...
  <br/>
            ...
            <br/>
            <br/>
            <h4 className='rms'>Raw Material Suppliers:</h4>
            <br/>
            <form className="for" onSubmit={handlerSubmitRMS}>
                <input className="form-control-sm add" type="text" onChange={handlerChangeAddressRMS} placeholder="Ethereum Address" required />
                <input className="form-control-sm add" type="text" onChange={handlerChangeNameRMS} placeholder="Raw Material Supplier Name" required />
                <input className="form-control-sm add" type="text" onChange={handlerChangePlaceRMS} placeholder="Place - Date" required />
            ...
            <br/>
            <h4 className='rms'>Manufacturers:</h4>
            <br/>
            <form className="for" onSubmit={handlerSubmitMAN}>
                <input className="form-control-sm add" type="text" onChange={handlerChangeAddressMAN} placeholder="Ethereum Address" required />
                <input className="form-control-sm add" type="text" onChange={handlerChangeNameMAN} placeholder="Manufacturer Name" required />
                <input className="form-control-sm add" type="text" onChange={handlerChangePlaceMAN} placeholder="Place - Date" required />
            ...
            <br/>
            <h4 className='rms'>Distributors:</h4>
            <br/>
            <form className="for" onSubmit={handlerSubmitDIS}>
                <input className="form-control-sm add" type="text" onChange={handlerChangeAddressDIS} placeholder="Ethereum Address" required />
                <input className="form-control-sm add" type="text" onChange={handlerChangeNameDIS} placeholder="Distributor Name" required />
                <input className="form-control-sm add" type="text" onChange={handlerChangePlaceDIS} placeholder="Place - Date" required />
            ...
            <br/>
            <h4 className='rms'>Retailers:</h4>
            <br/>
            <form className="for" onSubmit={handlerSubmitRET}>
                <input className="form-control-sm add" type="text" onChange={handlerChangeAddressRET} placeholder="Ethereum Address" required />
                <input className="form-control-sm add" type="text" onChange={handlerChangeNameRET} placeholder="Retailer Name" required />
                <input className="form-control-sm add" type="text" onChange={handlerChangePlaceRET} placeholder="Place - Date" required />
