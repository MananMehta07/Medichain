...
function Track() {
    ...
    if (TrackTillOrdered) {
        return (
            <div className="container-xl tab">
                <article className="col-4">
                    <h3><b><u>Medicine:</u></b></h3>
                    <span><div className='rms'><b>Medicine ID: </b>{MED[ID].id}</div></span>
                    <br />
                    <span><b>Name:</b> {MED[ID].name}</span>
                    <br />
                    <span><b>Description: </b>{MED[ID].description}</span>
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li onClick={redirect_to_home}><a class="nav-link scrollto active" href="#h">Medicine</a></li>
          <li onClick={redirect_to_home}><a class="nav-link scrollto active" href="#h">SupplyChain</a></li>
  ...
  <br/>
  <br/>
            <span><div className='caa'><b>Current Account Address:</b> {currentaccount}</div></span><br/>
            <div className='tab'>
            ...
            <br/>
            <h4 className='rms' >Enter Medicine ID to Track it</h4><br/>

            <form className='for'  onSubmit={handlerSubmit}>
                <input className="form-control-sm add" type="text" onChange={handlerChangeID} placeholder="Enter Medicine ID" required />
                <button className="btn btn-outline-success btn-sm add" onSubmit={handlerSubmit}>Track</button>
            </form>
